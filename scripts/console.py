...
def print_measure(measure:tuple[float], unit:str=None, name:str=None, significant_figures:int=None, force_scientific_notation:bool=False):
    """
...
def print_measure_list(measurements:list[tuple[float]], units:list[str]=None, names:list[str]=None, separator:str=" ", ending:str="", significant_figures:int=None, force_scientific_notation:bool=False):
    """
